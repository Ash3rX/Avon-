        ...
        this.run = async (interaction) => {
            if (interaction.isButton()) {
                ...
                if (interaction.customId === `avon_classic_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "avon-classic");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)
                                .setTitle(`Player Updated`)
                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Avon Classic Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `avon_spotify_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "avon-spotify");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)
                                .setTitle(`Player Updated`)
                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Avon x Spotify Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `avon_simple_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "avon-simple");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)
                                .setTitle(`Player Updated`)
                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Avon Simple Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `avon_special_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "avon-special");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)
                                .setTitle(`Player Updated`)
                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Avon Special Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)
                                .setTitle(`Player Updated`)
                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Avon No Buttons Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)
                                .setTitle(`Player Updated`)
                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Avon Old School Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `avon_dj_pause`) {
                    ...
                    let b1 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_previous`, null, this.client.emoji.setup.previous);
                    let b2 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_stop`, null, this.client.emoji.setup.stop);
                    let b3 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_pause`, null, dispatcher.player.paused
                        ? this.client.emoji.setup.pause
                        : this.client.emoji.setup.resume);
                    let b4 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_loop`, null, this.client.emoji.setup.loop);
                    let b5 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_skip`, null, this.client.emoji.setup.skip);
                    let b6 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_volLow`, null, this.client.emoji.setup.volLow);
                    let b7 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_fav`, null, this.client.emoji.setup.fav);
                    let b8 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_shuffle`, null, this.client.emoji.setup.shuffle);
                    let b9 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_autoplay`, null, this.client.emoji.setup.autoplay);
                    let b10 = this.client.utils.button(`custom_id`, null, 2, `avon_dj_volHigh`, null, this.client.emoji.setup.volHigh);
                    let row = this.client.utils.actionRow([b1, b2, b3, b4, b5]);
                    let row2 = this.client.utils.actionRow([b6, b7, b8, b9, b10]);
                    let opt1 = this.client.utils.menuOption(`Reset Filters`, null, `Resets all the filters of the player`, `avon_dj_filter_reset`);
                    let opt2 = this.client.utils.menuOption(`8D`, null, `Sets Up 8d filter to the player`, `avon_dj_filter_8d`);
                    let opt3 = this.client.utils.menuOption(`BassBoost`, null, `Sets bassboost filter to the player`, `avon_dj_filter_bassboost`);
                    let opt4 = this.client.utils.menuOption(`NightCore`, null, `Sets NightCore filter to the player`, `avon_dj_filter_nightcore`);
                    let opt5 = this.client.utils.menuOption(`Vaporwave`, null, `Sets Vaporwave filter to the player`, `avon_dj_filter_vibrato`);
                ...
                if (interaction.customId === `avon_pause`) {
                    ...
                    if (setting === `avon-old`) {
                        ...
                        let b2 = this.client.utils.button(`custom_id`, `${dispatcher.player.paused ? `Pause` : `Resume`}`, 3, `avon_pause`);
                        let b3 = this.client.utils.button(`custom_id`, `Loop`, 1, `avon_loop`);
                        let b4 = this.client.utils.button(`custom_id`, `Previous`, 2, `avon_previous`);
                    ...
                    if (setting === `avon-no`) {
                        let opt1 = this.client.utils.menuOption(`Reset Filters`, this.client.emoji.noButtons.filters, `Resets all the filters of the player`, `avon_filter_reset`);
                        let opt2 = this.client.utils.menuOption(`8D`, this.client.emoji.noButtons.filters, `Sets Up 8d filter to the player`, `avon_filter_8d`);
                        let opt3 = this.client.utils.menuOption(`BassBoost`, this.client.emoji.noButtons.filters, `Sets bassboost filter to the player`, `avon_filter_bassboost`);
                        let opt4 = this.client.utils.menuOption(`NightCore`, this.client.emoji.noButtons.filters, `Sets NightCore filter to the player`, `avon_filter_nightcore`);
                        let opt5 = this.client.utils.menuOption(`Vaporwave`, this.client.emoji.noButtons.filters, `Sets Vaporwave filter to the player`, `avon_filter_vibrato`);
                        let options = [opt1, opt2, opt3, opt4, opt5];
                    ...
                    if (setting === `avon-special`) {
                        let b1 = this.client.utils.button(`custom_id`, null, 4, `avon_previous`, null, this.client.emoji.special.previous);
                        let b2 = this.client.utils.button(`custom_id`, null, 4, `avon_shuffle`, null, this.client.emoji.special.shuffle);
                        let b3 = this.client.utils.button(`custom_id`, null, 4, `avon_pause`, null, dispatcher.player.paused ? this.client.emoji.special.pause : this.client.emoji.special.resume);
                        let b4 = this.client.utils.button(`custom_id`, null, 4, `avon_loop`, null, this.client.emoji.special.loop);
                        let b5 = this.client.utils.button(`custom_id`, null, 4, `avon_skip`, null, this.client.emoji.special.skip);
                        let b6 = this.client.utils.button(`custom_id`, null, 4, `avon_volLow`, null, this.client.emoji.special.volLow);
                        let b7 = this.client.utils.button(`custom_id`, null, 4, `avon_backward`, null, this.client.emoji.special.backward);
                        let b8 = this.client.utils.button(`custom_id`, null, 4, `avon_stop`, null, this.client.emoji.special.stop);
                        let b9 = this.client.utils.button(`custom_id`, null, 4, `avon_forward`, null, this.client.emoji.special.forward);
                        let b10 = this.client.utils.button(`custom_id`, null, 4, `avon_volHigh`, null, this.client.emoji.special.volHigh);
                    ...
                    if (setting === `avon-simple`) {
                        let opt1 = this.client.utils.menuOption(`Reset Filters`, this.client.emoji.simple.filters, `Resets all the filters of the player`, `avon_filter_reset`);
                        let opt2 = this.client.utils.menuOption(`8D`, this.client.emoji.simple.filters, `Sets Up 8d filter to the player`, `avon_filter_8d`);
                        let opt3 = this.client.utils.menuOption(`BassBoost`, this.client.emoji.simple.filters, `Sets bassboost filter to the player`, `avon_filter_bassboost`);
                        let opt4 = this.client.utils.menuOption(`NightCore`, this.client.emoji.simple.filters, `Sets NightCore filter to the player`, `avon_filter_nightcore`);
                        let opt5 = this.client.utils.menuOption(`Vaporwave`, this.client.emoji.simple.filters, `Sets Vaporwave filter to the player`, `avon_filter_vibrato`);
                        let options = [opt1, opt2, opt3, opt4, opt5];
                        let menu = this.client.utils.menu(`Choose filters`, `help-op`, options);
                        let row1 = this.client.utils.actionRow([menu]);
                        let b1 = this.client.utils.button(`custom_id`, null, 2, `avon_pause`, null, dispatcher.player.paused ? this.client.emoji.simple.pause : this.client.emoji.simple.resume);
                        let b2 = this.client.utils.button(`custom_id`, null, 2, `avon_skip`, null, this.client.emoji.simple.skip);
                        let b3 = this.client.utils.button(`custom_id`, null, 2, `avon_loop`, null, this.client.emoji.simple.loop);
                        let b4 = this.client.utils.button(`custom_id`, null, 2, `avon_stop`, null, this.client.emoji.simple.stop);
                    ...
                    if (setting === `avon-spotify`) {
                        let opt1 = this.client.utils.menuOption(`Reset Filters`, this.client.emoji.spotify.filters, `Resets all the filters of the player`, `avon_filter_reset`);
                        let opt2 = this.client.utils.menuOption(`8D`, this.client.emoji.spotify.filters, `Sets Up 8d filter to the player`, `avon_filter_8d`);
                        let opt3 = this.client.utils.menuOption(`BassBoost`, this.client.emoji.spotify.filters, `Sets bassboost filter to the player`, `avon_filter_bassboost`);
                        let opt4 = this.client.utils.menuOption(`NightCore`, this.client.emoji.spotify.filters, `Sets NightCore filter to the player`, `avon_filter_nightcore`);
                        let opt5 = this.client.utils.menuOption(`Vaporwave`, this.client.emoji.spotify.filters, `Sets Vaporwave filter to the player`, `avon_filter_vibrato`);
                        let options = [opt1, opt2, opt3, opt4, opt5];
                        let menu = this.client.utils.menu(`Choose filters`, `help-op`, options);
                        let row1 = this.client.utils.actionRow([menu]);
                        let b1 = this.client.utils.button(`custom_id`, null, 3, `avon_previous`, null, this.client.emoji.spotify.previous);
                        let b2 = this.client.utils.button(`custom_id`, null, 3, `avon_shuffle`, null, this.client.emoji.spotify.shuffle);
                        let b3 = this.client.utils.button(`custom_id`, null, 3, `avon_pause`, null, dispatcher.player.paused ? this.client.emoji.spotify.pause : this.client.emoji.spotify.resume);
                        let b4 = this.client.utils.button(`custom_id`, null, 3, `avon_loop`, null, this.client.emoji.spotify.loop);
                        let b5 = this.client.utils.button(`custom_id`, null, 3, `avon_skip`, null, this.client.emoji.spotify.skip);
                        let b6 = this.client.utils.button(`custom_id`, null, 3, `avon_volLow`, null, this.client.emoji.spotify.volLow);
                        let b7 = this.client.utils.button(`custom_id`, null, 3, `avon_backward`, null, this.client.emoji.spotify.backward);
                        let b8 = this.client.utils.button(`custom_id`, null, 3, `avon_stop`, null, this.client.emoji.spotify.stop);
                        let b9 = this.client.utils.button(`custom_id`, null, 3, `avon_forward`, null, this.client.emoji.spotify.forward);
                        let b10 = this.client.utils.button(`custom_id`, null, 3, `avon_volHigh`, null, this.client.emoji.spotify.volHigh);
