...
import { checkTrusted, manageMent } from "../api/db/management.js";
                ...
                return message
                    ...
                    components: [
                        this.client.utils.actionRow([
                            this.client.utils.button(`link`, `Invite Me`, null, null, `https://discord.com/api/oauth2/authorize?client_id=904317141866647592&permissions=8&scope=applications.commands%20bot`, this.client.emoji.invite),
