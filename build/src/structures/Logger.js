...
export default class AvonLogger {
    ...
    log(x) {
        return console.log(chalk.bgHex("#1c1a1b").hex("#ff3436").bold(time) +
            " | " +
            chalk.bold("[") +
    ...
    debug(x) {
        return console.debug(chalk.bgHex("#1c1a1b").hex("#ff3436").bold(time) +
            " | " +
            chalk.bold("[") +
    ...
    warn(x) {
        return console.warn(chalk.bgHex("#1c1a1b").hex("#ff3436").bold(time) +
            " | " +
            chalk.bold("[") +
