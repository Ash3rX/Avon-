        ...
        this.exec = async (message, args, prefix) => {
            if (!args[0]) {
                let em = this.client.utils
                    ...
                    .setFooter({
                    text: `Made By Team Avon`,
                    iconURL: message.author.displayAvatarURL({ dynamic: true }),
                })
                    .setTitle(`${this.client.user.username}'s Help`)
                    .setDescription(`Hey There It's ${this.client.user.username} True Definition of A best music bot. A music bot with all advanced features of reconnection and different search engines. Providing you the qulaity music for your server.\n\n•My default prefix for the server is: \`${prefix}\`\n•For More info over a command use: \`${prefix}help <command>\``)
                    .addFields([
                    {
