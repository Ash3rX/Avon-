...
export default class Trusted extends AvonCommand {
          ...
          return message.reply({
            embeds: [
              this.client.utils
                .errorEmbed()
                .setDescription(
                  `${this.client.emoji.cross} This User is already present in Trusted's List`
                ),
            ],
          });
        else {
          ...
          return message.reply({
            embeds: [
              this.client.utils
                .successEmbed()
                .setDescription(
                  `${this.client.emoji.tick} Successfully **Added** ${user.tag} to my **Trusted's List**`
                ),
            ],
          });
        }
          ...
          return message.reply({
            embeds: [
              this.client.utils
                .errorEmbed()
                .setDescription(
                  `${this.client.emoji.cross} This User is not present in Trusted's List`
                ),
            ],
          });
        else {
          ...
          return message.reply({
            embeds: [
              this.client.utils
                .successEmbed()
                .setDescription(
                  `${this.client.emoji.tick} Successfully **Removed** ${user.tag} from my Trusted's List`
                ),
            ],
          });
        }
